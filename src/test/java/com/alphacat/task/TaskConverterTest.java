...
public class TaskConverterTest {
    ...
    private HistoryTask h1 = new HistoryTask(1, "h1", Date.valueOf("2018-12-31"), 250, 0.9234, 1.0);
    private HistoryTask h2 = new HistoryTask(2, "h2", Date.valueOf("2017-12-31"), 0, 0.0000, 1.0);
    ...
    public void toHistoryVO() {
        HistoryTaskVO expected1 = new HistoryTaskVO(1, "h1",  "2018-12-31", 250, 0.9234, 1.0);
        HistoryTaskVO expected2 = new HistoryTaskVO(2, "h2", "2017-12-31", 0, 0.0000, 1.0);
